...
def main():
    ...
    make_json(
        ...
        'RWSAMamba-UNet/data/train_clean.json'
    )

    ## train_noisy
    make_json(
        os.path.join(prefix, 'noisy_train'),
        'RWSAMamba-UNet/data/train_noisy.json'
    )
    # ----------------------------------------------------------#
    ...
    make_json(
        ...
        'RWSAMamba-UNet/data/valid_clean.json'
    )

    ## valid_noisy
    make_json(
        os.path.join(prefix, 'noisy_valid/'),
        'RWSAMamba-UNet/data/valid_noisy.json'
    )
    # ----------------------------------------------------------#
    ...
    make_json(
       os.path.join(prefix, 'clean_test/'),
        'RWSAMamba-UNet/data/test_clean.json'
    )

    ## test_noisy
    make_json(
       os.path.join(prefix, 'noisy_test/'),
        'RWSAMamba-UNet/data/test_noisy.json'
    )
    # ----------------------------------------------------------#
